...
def worker_init_fn(worker_id):
    """Initialize worker with deterministic seed based on worker_id and global SEED."""
...
def weighted_epoch_sample(data_with_std, num_sample=400):
    ...
    # Use local RandomState to avoid resetting global seed
    rng = np.random.RandomState(SEED)
    sample_ides = rng.choice(
